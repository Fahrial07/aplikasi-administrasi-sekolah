...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'SIAP-SDIT Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'siapsditonline@gmail.com',
        ...
        $this->email->from('siapsditonline@gmail.com', 'SIAP SDIT');
        $this->email->to($this->input->post('email'));

        if ($type == 'verify') {
            $this->email->subject('Kode Aktivasi Akun SIAP SDIT');
            $this->email->message('silahkan klick tombol berikut untuk aktivasi akun SIAP SDIT : <a href="' . base_url() . 'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '" type="button" style="color: green;">Activate</a>');
        } else if ($type == 'forgot') {
            $this->email->subject('Reset Password Akun SIAP SDIT');
            $this->email->message('silahkan klick tombol berikut untuk reset password akun SIAP SDIT : <a href="' . base_url() . 'auth/resetpassword?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '" type="button" style="color: green;">Reset Password</a>');
        }
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'SIAP-SDIT Forgot Password';
            $this->load->view('templates/auth_header', $data);
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'SIAP-SDIT Change Password';
            $this->load->view('templates/auth_header', $data);
