    ...
    <div class="card-body p-0">
      ...
      <div class="row">
        <div class="col-lg-5 d-none d-lg-block text-center">
          <img src="<?= base_url('assets/'); ?>logo/logo-sdit.png" alt="logo-image" class="img-circle mt-5 mb-3" width="150px">
          <h1 class="h4 text-gray-900 mb-1"><b>SIAP</b>-<em>SDIT</em></h1>
          <p class="mb-5"><em class="text-primary">Sistem Administrasi</em></p>
          <p class="lead text-gray-900"><b>SSDIT AL ISLAMIYAH</b></p>
        </div>
        <div class="col-lg-7">
          <div class="p-4">
