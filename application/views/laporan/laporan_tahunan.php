			...
			<div class="col-lg-12">
				<div class="header mb-n5">
					<div class="row">
						...
						<div class="col-md-9 mt-5 text-dark">
							<div class="text-kop">
								<h3 class="ml-4"><b>Laporan Tahunan</b></h3>
				...
				<div class="table-responsive mt-n5">
					<table class="table table-bordered" border="1">
						...
						<tbody>
							<?php $no=1; foreach ($laporan_tahunan as $data) { ?>
							<tr>
								<td><?php echo $no; ?></td>
							...
							<tr>
								...
								<td><b>Rp. <?php echo number_format($jmll['jml_byr'],0,".","." )?></b></td>
								<td><b>Rp. <?php echo number_format($tgk['tunggak'],0,".","." )?></b></td>
